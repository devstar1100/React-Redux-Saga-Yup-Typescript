...
import SimulationBreadcrumbs from "./components/SimulationBreadcrumbs";
...
const AddEditSimulation = ({ isEditMode = false }: Props) => {
  ...
  return (
    <Wrapper>
      ...
      <Container
        breadcrumbs={<SimulationBreadcrumbs actionName={actionName} />}
        bottomActionBlock={
...
export default withSimulation(AddEditSimulation);
