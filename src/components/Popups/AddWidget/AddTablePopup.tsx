  ...
  return (
    <>
      ...
      <Typography
        ...
        onClick={() => addNewWidgetUnit({ "parameter-scale": "1.0" })}
      >
        Add New Parameter
      </Typography>
      {selectedUnitId && (
...
export default withAddWidget(AddTablePopup, {
  title: "Add / Edit Table",
  elementType: DisplayElementType.table,
  popup: Popups.addTable,
  stateGetterFunc: getAddTablePopupState,
});
