...
export const DELETE_SIMULATION_SERVER = "DELETE_SIMULATION_SERVER";
export const CLONE_SIMULATION_SERVER = "CLONE_SIMULATION_SERVER";
...
type AddSimulationServerProps = Pick<
  Simulation,
  | "simulation-name"
  | "simulation-owner-id"
  | "simulation-executable-path"
  | "simulation-base-folder-path"
  | "simulation-status-id"
  | "project-id"
  | "simulation-user-config-id"
  | "simulation-server-node-id"
  | "wait-for-go-when-launching"
  | "develop-simulation-output-folder-path"
>;

type EditSimulationServerProps = AddSimulationServerProps & Pick<Simulation, "simulation-id">;
...
export const addSimulationServer = (props: AddSimulationServerProps & RedirectProps) => ({
...
export const deleteSimulationServer = (props: Pick<Simulation, "simulation-id">) => ({
  type: DELETE_SIMULATION_SERVER,
  payload: {
    request: {
      method: "GET",
      url: `/manage-simulation/${props["simulation-id"]}/${ListUnitAction.delete}`,
    },
  },
});

export const cloneSimulationServer = (props: Pick<Simulation, "simulation-id"> & AddSimulationServerProps) => ({
  type: CLONE_SIMULATION_SERVER,
  payload: {
    request: {
      method: "GET",
      url: `/manage-simulation/${props["simulation-id"]}/${ListUnitAction.clone}`,
      params: { ...props },
    },
  },
});
